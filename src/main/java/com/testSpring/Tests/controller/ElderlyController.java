...
public class ElderlyController implements ProtocolMethods<Elderly>{
    ...
    @Override
    @PostMapping
    public Elderly post(@RequestBody Elderly user) {
        return null;
    }
    ...
    @Override
    @PutMapping("/{id}")
    public Elderly put(@PathVariable long id, @RequestBody Elderly user) {
    ...
    @Override
    @PatchMapping("/{id}")
    public Elderly patch(@PathVariable long id, @RequestBody Elderly user) {
